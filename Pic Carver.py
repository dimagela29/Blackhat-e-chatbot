...
pictures_directory = "pic_user/pictures"
...
def face_detect(path,file_name):
    ...
    img     = cv2.imread(path)
    cascade = cv2.CascadeClassifier("haarcascade_frontlface_alt.xml")
...
def get_http_headers(http_payload):
      ...
      try:
        #ssplit the headers off if it is HTTP traffic
...
def extract_image(headers,http_payload):
  ...
  def http_assembler(pcap_file):
      ...
      return carved_images, face_detected
