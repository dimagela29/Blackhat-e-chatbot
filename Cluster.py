import nlptoolkit utils misc as save_as_pickle
import logging
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gradient_macc_steps", type=int, default=1, help="No. of steps of gradient accumulation")
    parser.add_argument("--max_norm", type=float, default=1.0, help="Clipped gradient norm")
    parser.add_argument("--num_epochs", type=int, default=300, help="No of epochs")
    parser.add_argument("--lr", type=float, default=0.003, help="learning rate")
    parser.add_argument("--model_no", type=int, default=0, help='''Model ID: (0: Detraep Graph Infomax (DGI)),'''
    ...
    if args.model_no == 0:
        ...
        from nlptoolkit.clustering.models.DGI.infer import train_from_trained
    ...
    if args.infer == 1:
        ...
        pca, pca_embedings = inferer.PCA_analyze(n_componentes = 2)
